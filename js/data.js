...
function calcIndex(sa, fa, ha, aa) {
  ...
  const base = 50;
  const socialReduce = [0, -6, -12, -18, -24][sa]; // 社交好降低单身指数
  const filterAdd = [0, 5, 12, 20, 28][fa]; // 标准高增加单身指数
  const heartReduce = [0, -5, -10, -16, -22][ha]; // 心动多降低单身指数
  const aloneAdd = [0, 4, 10, 18, 25][aa]; // 越独立越难脱单
